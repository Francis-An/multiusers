                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form method="POST" action="/medicines" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                <label for="image"
                                    class="col-md-4 col-form-label text-md-end">{{ __('Drug Photo') }}</label>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="name" type="text"
                                        ...
                                        value="{{ old('name') }}" required autocomplete="generic_name" autofocus>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <input id="manufacture" type="text"
                                        ...
                                        required autocomplete="manufacture">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <textarea class="form-control form-control @error('drug_dosage') is-invalid @enderror"
                                        autocomplete="drug_dosage" name="drug_dosage" rows="3" required></textarea>

                                    <input id="dose" type="int" class="form-control" name="dose"
                                        value="1" hidden>
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-md-6">
                                    <textarea class="form-control form-control @error('drug_dosage_unit') is-invalid @enderror"
                                        autocomplete="drug_dosage_unit" name="drug_dosage_unit" rows="3" required></textarea>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="price" type="int" class="form-control @error('price') is-invalid @enderror"
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-md-6">
                            <input id="starting_date" type="date"
                                class="form-control @error('starting_date') is-invalid @enderror" name="starting_date"
                                required autocomplete="starting_date">
